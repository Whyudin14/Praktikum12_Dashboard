        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    &nbsp;
                    <a href= <?php echo base_url("index.php/matakuliah/delete_matakuliah/$matkul->id") ?> onclick="return hapusMatakuliah('Anda yakin ingin menghapus Nama Mata Kuliah <?php echo $matkul->nama ?>?')">
