            ...
            <div class="card-body">
                <div class="d-flex flex-column align-items-center text-center">
                    ...
                    <div class="mt-4">
                        ...
                        <!-- <?php echo $error;?> -->
                        <br/> <br/>
                        <a href="https://www.instagram.com/rojulman/" target="_blank"><button class="btn btn-outline-info">Instagram</button></a>
                        <br/> <br/>
                        <?php echo form_open_multipart('dosen/upload_dosen');?>
